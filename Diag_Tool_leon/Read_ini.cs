...
using System.Linq;
using System.Text;
using System.Runtime.InteropServices;  // using this namespace
...
namespace Diag_Tool_leon
{
    class Read_ini
    {
        ...
        //key：INI文件中的关键字；def：无法读取时候时候的缺省数值；retVal：读取数值；size：数值的大小；filePath：INI文件的完整路径和名称。
        [DllImport("kernel32.dll")]
        ...
        public Read_ini(string aFileName)
        {

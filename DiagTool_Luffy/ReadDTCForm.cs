...
{
    public partial class ReadDTCForm : Form
    {
        /* set updateDTCDisplay=true when send 19 02 XX */
        public bool updateDTCDisplay = false;
        ...
        private void ReadDTCFormClosing(object sender, FormClosingEventArgs e)
        {
            this.Hide();
            e.Cancel = true;
        }
        ...
        /* Update DTCList when Tx 19 02 XX or 19 0A*/
        private void SetUpdateDTCDisplay()
        {
            if ((this.ReadDTCComboBox.Text.Substring(3, 2) == "02") || (this.ReadDTCComboBox.Text.Substring(3, 2) == "0A"))
            {
                /* Clear DTCList display*/
                this.DTCDisplayTextBox.Text = "";
                this.updateDTCDisplay = true;
            }
        }
        ...
        private void ReadDTCButton_Click(object sender, EventArgs e)
        {
            ...
            if(msgData != "")
            {
                //Global.passThruWrapper.TxMsg(Global.diagUsercontrol.ReqIDTextBox_Text, msgData, Global.diagUsercontrol.TxRxMsgUpdateDiagDataGridViewCallback);
            }           
        }
    }
}
